...
sudo rm -rf /usr/local/share/remnux/remnux-logo.png && sudo rm -rf /var/cache/remnux/cli/v2022.44.5/salt-states-2022.44.5/remnux/theme/gnome-config/remnux-logo.png && sudo cp /opt/KASM/KASM/images/KASM.png /usr/share/backgrounds/KASM.png && gsettings set org.gnome.desktop.background picture-uri file:////usr/share/backgrounds/KASM.png
sleep 1
# set icons
...
sudo curl -Lo /usr/bin/theme.sh 'https://git.io/JM70M' && sudo chmod +x /usr/bin/theme.sh && /usr/bin/./theme.sh dracula
sleep 1
# configure .bashrc
sudo chmod +x /opt/KASM/KASM/scripts/config/configure.py && python3 /opt/KASM/KASM/scripts/config/configure.py
sleep 1
#sudo -E -u gvm -g gvm gvmd --rebuild #http://localhost:9392
