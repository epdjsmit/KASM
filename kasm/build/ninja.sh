...
if [[ $install_or_skip = *velociraptor* ]] || [ $length -eq "0" ]; then
...
# installing remaining software & cleaning up
clear
...
printf "
  ...
  #########################################"
sleep 4
printf "\n\n   Press ENTER to perform shutdown "
read input
sudo halt