...
echo " >> Please enter a password for the cuckoo account"
sudo passwd cuckoo
...
echo " >> Downloading and installing REMnux"
/opt/kasm/kasm/build/install/./remnux.sh # > /dev/null 2>&1
